...
namespace Rabbitmq.Common
{
    public class RabbitMQEventBus : BaseEventBus
    {
        ...
        public override Task PublishAsync<TEvent>(TEvent @event,string queName, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            //绑定队列，交换机，路由键
            channel.QueueBind(queName, exchangeName, routkey);
