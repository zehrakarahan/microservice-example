...
namespace CodeGenerator.CodeGenerator.DbFirst
{
    internal sealed class DbFirst : IDbFirst
    {
        ...
        public DbFirst(IOptions<CodeGenerateOption> option, IDbContextCore dbContext)
        {
            if (option == null) throw new ArgumentNullException(nameof(option));
            _dbContext = dbContext;
            AllTables = dbContext.GetCurrentDatabaseTableList().ToList();
